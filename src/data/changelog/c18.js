/**
 * Frozen changelog chunk c18 (2026-04-29).
 * Three entries from current.js when it crossed the 7KB freeze threshold
 * (10.3KB at freeze time). Newest first within file.
 */
export default [
  {
    date: '2026-04-29',
